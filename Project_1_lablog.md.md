...
Install all needed programs for MacOS/Windows with HomeBrew/apt get/conda/mamba (Seqkit, bwa, fastqc, Trimmomatic,
...
```Zsh
fastqc -o . amp_res_1_pairedfastq amp_res_2_paired.fastq
```
...
3) Create a folder for this database and copy unzipped DB to this folder
